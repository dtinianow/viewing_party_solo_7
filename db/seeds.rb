...
# create Parties
5.times do
  ViewingParty.create!(duration: rand(0..240), date: Faker::Date.forward(days: rand(1..14)),
                       start_time: Time.new.strftime('%H:%M'), movie_id_from_tmdb: 240, movie_title: 'The Godfather Part II')
end
